...
function App() {
  ...
  function getLocalStorage(){
    let api = localStorage.getItem("apiVersion");
    console.log("apiVersion: ", api)
    setApiVersion(api);
  }
              ...
              <>
                ...
                >
                  <div className="container">
                    ...
                    >
                      Join thousands of Developers & QA using ShadowdriverJS to
                      supercharge their testing workflows.
                    </p>
