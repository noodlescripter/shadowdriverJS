                                ...
                                {children ? children : (
                                    <div>
                                        <pre data-prefix=">" className="whitespace-pre-wrap">
                                            <code className="text-orange-500">npm install shadowdriver</code>
                                        </pre>
                                        <pre data-prefix=">" className="whitespace-pre-wrap">
                                            <code className="text-green-600">npx shadowdriver init</code>
                                        </pre>
                                        <pre data-prefix=">" className="whitespace-pre-wrap">
                                            <code className="text-red-600">npx shadow exec shadow.conf.js --spec e2e/sample/sample.spec.js</code>
                                        </pre>
                                    </div>
                                )}
