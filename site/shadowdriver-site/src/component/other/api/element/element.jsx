...
await button.click(); // returns true || false`,
      explanation: "Simulates a mouse click on the web element identified by the locator."
    },
    {
...
console.log(value); // logs the value attribute of the element`,
      explanation: "Fetches the value of a specified attribute for the element."
    },
    {
...
console.log(isEnabled); // returns true if the element is enabled, false otherwise`,
    ...
    },
    {
      ...
      explanation: "Pauses the execution for the specified number of milliseconds."
    },
    {
    ...
    <>
      <div className="mb-5">
        <div className="container">
          <h2 className="text-success fw-bold text-start mb-4 display-8">
            Element API
          </h2>
          <p className="text-white text-start fs-5 mb-2">Allows you to interact with DOM elements</p>
          <div className="bg-dark text-white p-4 rounded shadow-sm">
            <ul className="list-unstyled">
              {elements.map((item, index) => (
                <>
                  <li key={index} className="border-start border-4 border-success ps-3 mb-5">
                    <div className="d-flex align-items-center mb-1">
                      <span className="text-success me-2">
                        <i className="fas fa-arrow-right"></i>
                      </span>
                      <h4 className="text-success fw-bold m-0">{item.apiName}
      ...
      <div className="mt-5 p-4 text-white bg-bg-gradient rounded">
        ...
        <p className="fs-5">
          The Element APIs you see here are part of our custom toolkit, designed to provide 
          a simplified interface for working with DOM elements while leveraging the robust 
          capabilities of <span className="fw-bold text-success">WebDriverJS</span>. By acting 
          as a wrapper, our tools streamline the integration of complex WebDriverJS functionality, 
          making it easier for developers to write clean, efficient, and scalable test automation code.
        </p>
        <p className="fs-5">
          Whether you're interacting with elements, managing sessions, or executing advanced commands, 
          our toolkit bridges the gap between low-level API calls and high-level automation needs. 
          This enables rapid development without compromising the power and flexibility of WebDriverJS.
        </p>
        <p className="fs-5">
